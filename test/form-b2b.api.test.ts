...
const { GET: GET_COUNTER, POST, PUT } = require('../src/app/api/form-b2b/route')
const { GET: GET_BY_CODE } = require('../src/app/api/form-b2b/[code]/route')
const { GET: GET_HISTORY } = require('../src/app/api/form-b2b/history/[code]/route')

describe('/api/form-b2b (integration style unit tests)', () => {
  let mockDb: any
  ...
  it('GET counter returns default when prefix/dmy missing', async () => {
    const req = new Request(new URL('http://localhost/api/form-b2b')) as any
  ...
  it('POST rejects invalid payload', async () => {
    const req = new Request(new URL('http://localhost/api/form-b2b'), {
      method: 'POST',
      body: JSON.stringify({}),
    }) as any
